...
public class MessageAdapter extends BaseAdapter implements ListAdapter {
    ...
    List<CaulisMessage> messages = new ArrayList<CaulisMessage>();
    Context context;
    ...
    public void add(CaulisMessage message) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        CaulisMessage message = messages.get(i);

        if (/*message.isBelongsToCurrentUser()*/message!=null) { // this message was sent by us so let's create a basic chat bubble on the right
